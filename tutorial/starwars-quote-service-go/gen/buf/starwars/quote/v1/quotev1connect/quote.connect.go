...
import (
	...
	v1 "github.com/bufbuild/knit/tutorial/starwars-quote-service-go/gen/buf/starwars/quote/v1"
	http "net/http"
	strings "strings"
)
...
func NewQuoteServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) QuoteServiceClient {
	...
	return &quoteServiceClient{
		streamQuotes: connect_go.NewClient[v1.StreamQuotesRequest, v1.StreamQuotesResponse](
			httpClient,
			baseURL+"/buf.starwars.quote.v1.QuoteService/StreamQuotes",
			opts...,
		),
	}
}
...
func NewQuoteServiceHandler(svc QuoteServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/buf.starwars.quote.v1.QuoteService/StreamQuotes", connect_go.NewServerStreamHandler(
		"/buf.starwars.quote.v1.QuoteService/StreamQuotes",
		svc.StreamQuotes,
		opts...,
	))
