...
import (
	...
	v1 "github.com/bufbuild/knit/tutorial/starwars-starship-service-go/gen/buf/starwars/starship/v1"
	http "net/http"
	strings "strings"
)
...
func NewStarshipServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) StarshipServiceClient {
	...
	return &starshipServiceClient{
		getStarships: connect_go.NewClient[v1.StarshipsRequest, v1.StarshipsResponse](
			httpClient,
			baseURL+"/buf.starwars.starship.v1.StarshipService/GetStarships",
			opts...,
		),
	}
}
...
func NewStarshipServiceHandler(svc StarshipServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/buf.starwars.starship.v1.StarshipService/GetStarships", connect_go.NewUnaryHandler(
		"/buf.starwars.starship.v1.StarshipService/GetStarships",
		svc.GetStarships,
		opts...,
	))
